...
**Script Pratique** : `01_tokenization_embeddings.py`
...
**Script Pratique** : `02_multihead_attention.py`
...
**Script Pratique** : `03_temperature_softmax.py`
...
**Script Pratique** : `08_lora_finetuning_example.py`
...
**Script Pratique** : `03_temperature_softmax.py` (température)
...
**Script Pratique** : `05_pass_at_k_evaluation.py`
...
**Scripts Pratiques** :
- `04_rag_minimal.py` : RAG avec TF-IDF
- `07_llamaindex_rag_advanced.py` : RAG production avec LlamaIndex
...
**Scripts Pratiques** :
- `06_react_agent_bonus.py` : Agent ReAct basique
- `09_mini_assistant_complet.py` : Agent complet (voir suite)
