...
Tous les scripts se trouvent à la racine du dépôt (pas en sous-dossier).
...
## 📚 Correspondance Chapitres ↔ Scripts

| Chapitre | Titre | Script |
|----------|-------|--------|
| 1 | Introduction | Aucun (théorique) |
| 2-3 | Tokenisation & Attention | 01-02 |
| 7 | Pré-entraînement | 03 (température) |
| 9 | LoRA Fine-tuning | 08 |
| 11 | Prompting & Génération | 03, 09 |
| 12 | Évaluation | 05, 09 |
| 13 | RAG | 04, 07, 09 |
| 14 | Agents ReAct | 06, 09 |
| 15 | Production | 09 |
...
- Lire Chapitre 15
- **Exécuter Script 09** ← Intégration complète
...
- [QUICKSTART_SCRIPT_09.md](./QUICKSTART_SCRIPT_09.md) → Exécuter et comprendre
- [SCRIPT_09_MAPPING.md](./SCRIPT_09_MAPPING.md) → Code ↔ Concepts
- [PEDAGOGICAL_JOURNEY.md](./PEDAGOGICAL_JOURNEY.md) → Parcours complet
- [REACT_AGENT_INTEGRATION.md](./REACT_AGENT_INTEGRATION.md) → Agents avancés
- [LLAMAINDEX_GUIDE.md](./LLAMAINDEX_GUIDE.md) → RAG production

---

**Bienvenue dans le monde des LLMs modernes ! 🚀**

Voir [QUICKSTART_SCRIPT_09.md](./QUICKSTART_SCRIPT_09.md) pour commencer.
